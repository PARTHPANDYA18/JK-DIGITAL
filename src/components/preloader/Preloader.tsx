    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center max-w-md w-full px-6 text-center">
          ...
          >
            <div className="relative w-24 h-24 rounded-2xl bg-neutral-900/90 border border-white/10 flex items-center justify-center shadow-[0_0_50px_rgba(255,107,0,0.35)] p-3">
              <Image
                src="/logo-white.png"
                alt="JK Digital Solutions Logo"
                width={80}
                height={68}
                className="object-contain h-full w-auto drop-shadow-[0_0_15px_rgba(255,107,0,0.5)]"
                priority
              />
